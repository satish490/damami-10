...
class FaqFieldDefaultWidget extends WidgetBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $elements['advanced']['question_rows'] = [
      ...
      '#options' => [
        $this->t('Fieldset'),
        $this->t('Textarea, 1 row'),
        $this->t('Textarea, 2 row'),
        $this->t('Textarea, 3 row'),
        $this->t('Textarea, 4 row'),
      ],
      '#required' => TRUE,
  ...
  public function settingsSummary() {
    ...
    $summary[] = $this->t('Answer widget title: @title', ['@title' => $this->getSetting('answer_title')]);
    $summary[] = $this->t('Question widget title: @title', ['@title' => $this->getSetting('question_title')]);
