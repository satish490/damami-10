/**
 * @file
 * Media Library overrides for thakurji_admin
 */
(($, Drupal, window) => {
  /**
   ...
   */
  Drupal.behaviors.MediaLibraryItemSelectionthakurji_admin = {
    attach() {
      ...
      if (!once('media-library-selection-info-thakurji_admin-event', 'html').length) {
        return;
      }
