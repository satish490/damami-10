/**
 * @file
 * thakurji_admin's enhancement for autocomplete form element.
 */

// cspell:ignore is-autocompleting

(($, Drupal, once) => {
  Drupal.behaviors.thakurji_adminAutoCompete = {
    attach(context) {
      once('thakurji_adminAutoComplete', 'input.form-autocomplete', context).forEach(
        (value) => {
          const $input = $(value);
