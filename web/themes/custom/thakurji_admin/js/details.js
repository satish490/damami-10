/**
 * @file
 * thakurji_admin's polyfill enhancements for HTML5 details.
 */
...
(($, Drupal) => {
   ...
   */
  Drupal.behaviors.thakurji_adminDetails = {
    attach(context) {
      ...
      $(once('thakurji_adminDetails', context === document ? 'html' : context)).on(
        'click',
        (event) => {
  ...
  Drupal.theme.detailsSummarizedContentWrapper = () =>
    `<span class="thakurji_admin-details__summary-summary"></span>`;
