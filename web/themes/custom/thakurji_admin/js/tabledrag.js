...
(($, Drupal) => {
   ...
   */
  Drupal.behaviors.thakurji_adminTableDrag = {
    attach(context, settings) {
       ...
       *   </tr>
       * @example
       * <!-- thakurji_admin tabledrag structure, this fixes the wrapping problem. -->
       *   <tr class="draggable">
  ...
  $.extend(Drupal.tableDrag.prototype.row.prototype, {
    ...
    /**
     * Moves added indents into thakurji_admin's wrapper element.
     *
