/**
 * @file
 * Extends table select functionality for thakurji_admin.
 */

(($, Drupal, { tabbable }) => {
  Drupal.thakurji_adminBulkActions = class {
  ...
  Drupal.behaviors.thakurji_adminTableSelect = {
    attach(context) {
      const bulkActions = once(
        'thakurji_adminBulkActions',
      ...
      bulkActions.map(
        (bulkActionForm) =>
          ...
          new Drupal.thakurji_adminBulkActions(bulkActionForm),
      );
    },
  };
