...
namespace Drupal\thakurji_admin;

use Drupal\Core\Render\Element;
use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the thakurji_admin theme.
 *
 * @internal
 */
class thakurji_adminPreRender implements TrustedCallbackInterface {
